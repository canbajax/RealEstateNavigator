        ...
        <div className="bg-white rounded-lg p-4 sm:p-6 max-w-5xl mx-auto shadow-lg">
          <Tabs defaultValue="sell" onValueChange={handleTabChange}>
            ...
            <TabsContent value="rent" className="mt-0">
              <div className="grid grid-cols-1 lg:grid-cols-7 gap-4">
                {/* Same structure as sell tab but with rent-specific fields */}
                {/* Using the same fields for simplicity */}
                <div className="lg:col-span-2">
                  <label className="block text-sm font-medium text-[#7F8C8D] mb-1">Konum</label>
                  <div className="relative">
                    <Select onValueChange={(value) => handleSelectChange("location", value)}>
            ...
            <TabsContent value="daily" className="mt-0">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-7 gap-4">
                {/* Similar structure to other tabs but for daily rentals */}
                <div className="lg:col-span-2">
                  <label className="block text-sm font-medium text-[#7F8C8D] mb-1">Konum</label>
                  <div className="relative">
                    <Select onValueChange={(value) => handleSelectChange("location", value)}>
                ...
                <div className="lg:col-span-2">
                  <label className="block text-sm font-medium text-[#7F8C8D] mb-1">Günlük Kira Aralığı</label>
                  <div className="flex">
                    <Input 
                      type="number" 
                      placeholder="Min ₺" 
